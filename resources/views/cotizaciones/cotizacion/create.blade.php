...
<div class="col-lg-6 container-fluid">
    ...
    {!!Form::open(array('url'=>'cotizaciones/cotizacion','method'=>'POST','autocomplete'=>'off'))!!}
    {{Form::token()}}
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 mt-4">
            <div class="form-group">
                <a href="{{URL::action('ClienteController@edit',$cliente->idcliente)}}"> <button type="button" id="bt-edit" class="btn btn-info">Editar</button></a>
                <a href="{{URL('cotizaciones/cliente/create')}}"> <button type="button" class="btn btn-success ml-2">Nuevo</button></a>
            </div>
        </div> 
    </div>    
        ...
        <div class="form-row">
            ...
            <div class="row">                    
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                    <div class="form-group">
                        <label for="precio_cotizacion">Precio Venta</label>
                        <input type="number" disabled name="pprecio_cotizacion" id="pprecio_cotizacion"
       ...
       function getProducts() {
            $.ajax({
                ...
                success: ({ data }) => {
                    ...
                    /*$(".add-cotizacion22").click((e) => {
                        var producto_id = $(e.target).attr('idprod')
                        $('#productCotization').modal('show')
                        $("#saveCotizacion").click((e) => {
                            var data = {
                                producto_id,
                                cantidad: $('#pcantidad').val(),
                                stock: $('#pstock').val(),
