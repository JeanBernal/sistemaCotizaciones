...
roler="dialog" tabindex="-1" id="modal-delete-{{$catprod->idcategoria_producto}}">
    {{Form::Open(array('action'=>array('Categoria_productoController@destroy', $catprod->idcategoria_producto),'method'=>'delete'))}}
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Está a punto de eliminar una categoría</p>
